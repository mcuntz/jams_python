...
from ufz.color import brewer_sequential, brewer_diverging, brewer_qualitative
from ufz.color import oregon_sequential, oregon_diverging, oregon_qualitative
from ufz.color import ncl_large, ncl_small, ncl_meteo_swiss, mathematica
...
def register_brewer(cname='all', reverse=False, grey=False, gray=False):
    ...
    from ufz.color import rgb2rgb01
    if cname.lower() == 'all':
        cmaps = all_maps
...
def get_brewer(cname=None, names=False, rgb=False, rgb256=False, reverse=False, grey=False, gray=False):
    """
        ...
        ['242.9897' '242.9897' '242.9897']
    """
    from ufz.color import rgb2rgb01, rgb012rgb
    if names:
        if names.lower() == 'sequential':
