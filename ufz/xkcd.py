...
def xkcd(ax,
    ...
    # from ufz.find_in_path import find_in_path
    # fhumor = find_in_path('Humor-Sans.ttf') # in PYTHON_chs_lib
    import os
    fhumor = os.path.join(os.path.dirname(__file__), 'Humor-Sans.ttf') # in PYTHON_chs_lib/ufz
