...
def savitzky_golay(y, window, order, deriv=0, rate=1):
    """
       ...
       >>> print astr(savitzky_golay(y, 3, 1, deriv=1), 15)
       ['-0.000000000000000' '-0.050229496646949' ' 0.072945060848425'
        ' 0.441633401170031' ' 0.295156494577998' '-0.303885643073806'
        '-0.368285621730698' '-0.120119682765062' ' 0.009212481884223'
        ' 0.000000000000000']

       >>> print astr(savitzky_golay(y, 3, 1, deriv=1, rate=10), 15)
       ['-0.000000000000000' '-0.502294966469486' ' 0.729450608484247'
        ' 4.416334011700311' ' 2.951564945779978' '-3.038856430738060'
        '-3.682856217306984' '-1.201196827650617' ' 0.092124818842235'
        ' 0.000000000000000']
...
def savitzky_golay2d(z, window, order, deriv=None):
    """
       ...
       >>> from autostring import *
       >>> print astr(sg2d(Zn, window=3, order=2), 15)
       [[' 0.079809467632172' ' 0.052118039575328' '-0.105510940648604'
         '-0.165062449047733' ' 0.161053172823250']
        ['-0.204263418319561' ' 0.170092214277885' ' 0.663546709885688'
         ' 0.181036610360179' ' 0.047563872070684']
        [' 0.110597709964098' '-0.229651851669770' ' 0.093830120606460'
         '-0.170155382747355' ' 0.239542094791241']]

       >>> s2 = sg2d( Zn, 3, 2, deriv=1)
       >>> print astr(s2[0], 15)
       [[' 0.155779514527380' ' 0.046494458205916' '-0.046121220850609'
         ' 0.065018838742990' ' 0.257150006378453']
        [' 0.304848635659043' ' 0.086796881190688' '-0.007029950727875'
         '-0.054633811445529' ' 0.230404675187197']
        [' 0.304848635659043' ' 0.125648733454403' '-0.039181966049651'
         '-0.158482582925357' ' 0.120366209085626']]
       >>> print astr(s2[1], 15)
       [['-0.069451188232359' ' 0.509989804435702' ' 0.637919058071323'
         ' 0.445685773792149' ' 0.127929253635621']
        ['-0.101966867277114' '-0.046828905807197' '-0.018457182670329'
         ' 0.038767687624949' ' 0.026836181301076']
        [' 0.555717279729358' ' 0.250868644070315' '-0.000000000000000'
         ' 0.092168189662821' ' 0.111350476304082']]
