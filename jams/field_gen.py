...
class RNG(object):
    """Wrapper class for random number generators with a consistent interface.
        ...
        interface for RNGs, if different distributions are needed.
         ...
         License:
         This class is part of the JAMS Python package.
...
class Field(object):
    """Generates a 2d random hydraulic conductivity field.
        ...
        A Randomization algorithm (Heße et al. 2014, Environ. Model. Softw.) to
...
#        (Heße et al. 2014, Environ. Model. Softw.) together with a projector to
